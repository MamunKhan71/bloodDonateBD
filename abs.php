...
<body>
    ...
    <div class="container cont">
        ...
        <div class="row col-lg-8 col-md-8 col-sm-12 mb-3">
            ...
            <label class="font-weight-bolder">রক্তের গ্রুপ নির্বাচন:</label>
               ...
               <a href="abs.php" class="btn btn-info mr-4" style="background-color:red;border:0px"> রিসেট</a>
        ...
        <table class="table table-striped rounded mb-5">
            <tr><th colspan="7" class="title">এভেইলেবল রক্ত সমূহ</th></tr>
            <tr>
                <th>#</th>
                <th>হাসপাতালের নাম</th>
                <th>হাসপাতালের শহর</th>
                <th>হাসপাতালের ইমেইল</th>
                <th>হাসপাতালের মোবাইল</th>
                <th>রক্তের গ্রুপ</th>
                <th>পদক্ষেপ</th>
            </tr>
        ...
        <?php while($row = mysqli_fetch_array($result)) { ?>
            ...
            <tr>
                ...
                <td><a href="javascript:void(0);" class="btn btn-info hospital">স্যাম্পল অনুরোধ</a></td>
