...
<body>
	...
	<table class="table  table-striped rounded mb-5" style="font-family: Li Ador Noirrit">
		<tr><th colspan="9" class="title">রক্ত দান</th></tr>
		<tr>
			<th>#</th>
			<th>নাম</th>
			<th>ইমেইল</th>
		    ...
		    <div>
                ...
                }else echo '<b style="color:white;background-color:red;padding:7px;border-radius: 15px 50px;">কেউ অনুরোধ করেনি</b>';
            }
            ?>
            </div>
